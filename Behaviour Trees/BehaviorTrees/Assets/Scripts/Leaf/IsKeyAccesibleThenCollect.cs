...
namespace AISandbox
{
    class IsKeyAccesibleThenCollect : Leaf
    {
        ...
        {          
            ...
            {
                if (BitManipulator.IsBitClear(GameManager.gameManager.controlbits,
                    GameManager.gameManager.specialNodeNumber))
                {
                    ...
                    if (Pathfollowing.StartPathFinding())
                    {
                        ...
                        BitManipulator.SetBit(ref GameManager.gameManager.controlbits, (byte)GameManager.gameManager.specialNodeNumber);                                 
                    }
                    else
                    {
